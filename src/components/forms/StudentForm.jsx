...
export default function StudentForm({ btnText, icon, color, method, id, student, courseCode, enrolledByTeacher }) {
        ...
        if (res.issues) {
          ...
          Swal.fire(method === 'POST' ? 'Estudiante matriculado exitosamente' : 'Los datos del estudiante han sido actualizados exitosamente')
            .then(result => {
              ...
              enrolledByTeacher ? location.href = `/courses/${courseCode}` : location.href = '/'
            })
        }
      })
  }
